                ...
                child: Visibility(
                  visible: quest["proofdocuments"].length == 0 ? false : true,
                    child: Wrap(
                      ...
                      children: quest["proofdocuments"].map<Widget>((imgelement){
                        bool image = true;
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(AppTranslations.of(context)!.text("key_audit_comp_by"),style: headingTextStyle,),
                Text(auditObj["completeby"],style: labelTextStyle,),
                SizedBox(
                  height: 10,
                ),
                Text(AppTranslations.of(context)!.text("key_audit_comp_date"),style: headingTextStyle,),
                Text(auditObj["complete_date"] == null ? "" : Jiffy.parse(auditObj["complete_date"]).format(pattern: "dd/MM/yyyy"),style: labelTextStyle,),
                SizedBox(
                  height: 10,
                ),
                Text(AppTranslations.of(context)!.text("key_audit_publish_by"),style: headingTextStyle,),
                Text(auditObj["publishby"],style: labelTextStyle,),
                SizedBox(
                  height: 10,
                ),
                Text(AppTranslations.of(context)!.text("key_audit_publish_date"),style: headingTextStyle,),
                Text(auditObj["publish_date"] == null ? "" : Jiffy.parse(auditObj["publish_date"]).format(pattern: "dd/MM/yyyy"),style: labelTextStyle,),
                SizedBox(
                  height: 10,
                ),
